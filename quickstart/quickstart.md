...
> a.  Query all the data, using comp_time as an index, which will
...
Commands available in dsosql are attach, create_part, create_schema,
...
To update a record in a DSOS database, the update needs to be bounded by
